...
//    fun setPluginEnabledInProject(project: Project, value: Boolean) = setEnabled(project, PLUGIN_ENABLED_IN_PROJECT, value)
        ...
        fun isTopLevelListsAtBottom(properties: PropertiesComponent): Boolean = isEnabled(properties, TOP_LEVEL_LISTS_AT_BOTTOM_ENABLED)
        fun isTopLevelListsAtBottom(project: Project): Boolean = isEnabled(project, TOP_LEVEL_LISTS_AT_BOTTOM_ENABLED)
        ...
        private const val TOP_LEVEL_LISTS_AT_BOTTOM_ENABLED = PREFIX + "TOP_LEVEL_LISTS_AT_BOTTOM_Enabled"
    }
}
