...
class FileUtil {
  companion object {
    ...
    fun convertConfToProperties(lines: List<String>): MutableList<String> {
      ...
      createParsingMap(lines, keyStack, outputLines)
    ...
    fun createParsingMap(lines: List<String>, keyStack: Stack<String>, outputLines: MutableList<String>): MutableMap<String, Any> {
      val map = mutableMapOf<String, Any>()
